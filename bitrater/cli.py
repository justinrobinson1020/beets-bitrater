...
def cmd_analyze(args: argparse.Namespace) -> None:
    ...
    use_dl = not getattr(args, "no_dl", False)
    analyzer = AudioQualityAnalyzer(use_dl=use_dl)
...
def main() -> None:
    ...
    p_analyze.add_argument("--model", help="path to trained SVM model file")
    p_analyze.add_argument(
        "--no-dl", action="store_true", help="disable deep learning model, use SVM only"
    )
